...
const theme = EditorView.theme(
  {
    ...
    '.fx-gutter': { width: '108px' },
    '.fx-gutter .cm-gutterElement': { padding: '0 8px', textAlign: 'right' },
    // Etiquetas de elemento a color (escaneabilidad, ref. Script Writer X): pastilla suave por tipo.
    '.fx-tag': { display: 'inline-block', fontFamily: 'system-ui, sans-serif', fontSize: '9px', fontWeight: '700', letterSpacing: '0.03em', padding: '1px 6px', borderRadius: '5px', whiteSpace: 'nowrap' },
    '.fx-tag-heading': { color: '#ff7a6b', backgroundColor: 'rgba(255,122,107,0.14)' },
    '.fx-tag-action': { color: '#5a9cff', backgroundColor: 'rgba(90,156,255,0.14)' },
    '.fx-tag-character': { color: '#3fb950', backgroundColor: 'rgba(63,185,80,0.14)' },
    '.fx-tag-dialogue': { color: '#4cc2b0', backgroundColor: 'rgba(76,194,176,0.14)' },
    '.fx-tag-parenthetical': { color: '#d9a441', backgroundColor: 'rgba(217,164,65,0.14)' },
    '.fx-tag-transition': { color: '#a371f7', backgroundColor: 'rgba(163,113,247,0.14)' },
    '.fx-tag-centered': { color: 'var(--dim)' },
    '.fx-tag-note': { color: '#c9a227', backgroundColor: 'rgba(201,162,39,0.14)' },
